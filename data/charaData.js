...
var bioData_en = [
    ...
    },
    {
        ...
        bio: [
            "Xiu was once a very caring and kindhearted nerdy boy. He and Axel go all the way back, they used to play league match together all the time and dated for a while. It all changed when Xiu started to get bullied by his \"friend\". Unable to handle the harassment, one day he just snapped and resorted to revenge. Although this has made him more confident and brave, it nevertheless brought him more trouble than before, and caused Axel to leave him.",
            "After Axel broke up with him, He stopped playing games and shifted his focus onto social media. He took interest in entertainment performing due to infulencers, and begins to work in bars to practice his new favorite stunt: flair bartending. He was able to earn a good amount of followers online due to his charismatic personality, but also got himself in flame from time to time due to problematic posts. It is around this time that he damaged his right eye from a dangerous streaming challange.",
