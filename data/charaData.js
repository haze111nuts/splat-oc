...
var bioData_ch = [
    {
        ...
        bio: [
            '原名布蘭登，因為長期被姐姐欺負跟貶低所以性格孤僻。',
            '原本不肯參加任何漆彈戰鬥並且非常抗拒交朋友，後來因緣際會遇上司令勉強同意變成3號，之間也結識了1號與2號，在三人的支持下決定開始嘗試改變態度和擺脫陰影，透過3號的任務持續練習後終於漸漸變得可以和別人比賽，也是這時決定改名布雷德並搬出去自己住。',
            '在認識亞克和其他朋友後開始打開心房並逐漸變得要好，並且決定以小布為中心組一個隊伍。'
        ]
    },
    {
        id: 'axel',
        ...
        bio: [
            ...
            '一次比賽隨機排到小布，兩人起了衝突並且演變成打架，最後搞到不歡而散時，忽然萌生了想和小布組隊的想法便追了回去。結果在下水道追丟對方，接著誤打誤撞進入峽谷區遇到了螢，為了要問出小布的下落而同意當上了4號。經過一番折騰後終於如願認識小布並且組成隊伍。' 
        ]
    },
    {
        id: 'xiu',
        ...
        bio: [
            '從小就是可以輕易融入人群的性格，會在聚會跟派對提出一堆團康鬼點子的人。',
            '起初跟亞克在一起時還會偶爾和他一起比賽，但分手後就全力投入網路社交媒體世界，幾乎沒再碰過武器。直到一次透過亞克打聽到小布而起了興趣，一起相處一陣子後決定回歸並和他們組隊。'
        ]
    },
    {
        id: 'yoni',
        ...
        bio: [
            '從小就是無憂無慮、開朗的性格。',
            '喜歡成癮的感覺，但因為漆彈協會禁止玩家使用非法藥物，所以自從加入小布和亞克的隊伍之後就漸漸不用了。不過毒癮終究難戒，所以他正在找一種能讓他上癮又能繼玩漆彈的辦法。',
            '似乎有參與一些可疑活動。'
        ]
    },
    {
        ...
        bio: [
            ...
            '漆彈戰鬥就是她的全部，只要心情一不好就會去戰鬥發洩。大概是因為將身心都投入漆彈比賽中所以技術異常高超，是玩風非常猛烈的前鋒系。自主拉了蘭斯、RJ、米娜瓦組了一個表現頂尖的隊伍。',
    ...
    },
    {
        ...
        bio: [
            '尤尼的哥哥，從小就認識小布姊弟。看上去凶狠又沒表情卻是個可靠又很照顧人的傢伙。做事有條有理注重細節、高標準完美主義。三觀端正，常常會面無表情的給予人生諫言。努力與自己的OCPD共存中，總是戴著黑手套',
            '是漢娜最早拉近MM的成員，漢娜處理不了的事情都是他在處理。'
        ]
    },
    {
        id: 'ellie',
        ...
        bio: [
            '艾克索爾的妹妹，青春洋溢的女生，雖然很好相處但正義感過剩，常在網路上炎上別人。',
            '平時喜歡社交聊天，在看見哥哥總是跟隊友往外跑後慢慢開始對漆彈有興趣。'
        ]
    },
    {
        id: 'edd',
