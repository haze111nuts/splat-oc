...
var relationshipData_ch = [
    ...
    },
    {
        ...
        content: [
            "從小媽媽就非常偏袒小布，漢娜得到的只有忽視，因此對弟弟有極大的心結。自從媽媽過世以後漢娜就開始生理與心理家暴。漢娜脾氣好的時候冷落他，脾氣差則用很惡劣的話語去刺激弟弟或是乾脆狠狠揍他一頓。",
            "對於漢娜的暴力行為，小布採取迴避措施，能躲就躲。",
            "雖然很怕漢娜，但小布還是默默和她一起生活，食物也會準備她的份，這件事也讓漢娜覺得很煩，並且覺得互相討厭比較輕鬆。",
            "在小布因緣際會當上３號並開始找到人生新方向時，才終於下定決心跟漢娜分開。"
        ]
    },
    {
        id: "AB",
