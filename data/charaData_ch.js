...
var bioData_ch = [
    {
        ...
        bio: [
            ...
            '原本是個不肯參加任何漆彈戰鬥並且非常抗拒交朋友的叛逆男孩，後來因緣際會遇上司令勉強同意變成３號，之間也結識了１號與２號，在三人的支持下決定開始嘗試改變態度和擺脫陰影，透過英雄任務持續練習的他終於變得可以和別人比賽，也是這時決定改名布雷德並搬出去自己住。',
    ...
    },
    {
        ...
        bio: [
            ...
            '在被霸凌的低潮期遇到亞克並走到一起，起初還會常常他一起比賽，但分手後就全力投入網路社交媒體世界還有花式調酒師生涯，幾乎沒再碰過武器。直到一次透過亞克打聽到小布而起了興趣，和他們相處一陣子後決定回歸漆彈並和他們組成Rotten Buttons。',
    ...
    },
    {
        ...
        bio: [
            ...
            '對自己的性格問題有一定程度的理解，曾透露出想和弟弟緩解關係的念頭，但還是在沒能做出任何有用的嘗試後放棄，並表示「已經無法回頭了」。'
        ]
    },
    {
        id: 'lance',
        ...
        bio: [
            ...
            '努力與自己的OCPD共存中，總是戴著黑手套。早上戰鬥前一定要吃一包跳跳糖。'
        ]
    },
    {
        id: 'ellie',
    ...
    },
    {
        ...
        bio: [
            ...
            '在還沒能逃出之前被捲入深海地下鐵事件，最後終於如願到達陸上，他把和當時作為３號出勤的小布視為救世主般的存在，兩人當上朋友後，艾德成為了Rotten Buttons的第五個成員。'
        ]
    },
    {
        id: 'minerva',
    ...
    },
    {
        ...
        bio: [
            ...
            '原本是個成天窩在研究室的家裡蹲，一次在蛸壺山谷巡邏檢查損毀機器時發現小布（３號）並接上他的無線電，之後擅自認定對方為自己的死對頭，接著便對他展開至死不渝的糾纏。他對亞克（４號）也是類似的狀況。因為思想不周所以計畫總是不成功，機器人也每次都被打爆，即使如此他仍然沒有絲毫要放棄的意思。總之就是個經典定番惡役。',
            '從沒有去過陸上也沒有任何類似的打算。'
        ]
    },
    {
        ...
        bio: [
            ...
            '在對戰圈神出鬼沒，可調閱的戰鬥資歷非常少，狙數跟準度卻高的駭人。跟蘭斯有過不少次生死決鬥，所以不知何時就熟了起來。漢娜也因此有辦法找到他並向他提出加入Midnight Mayhem的請求，RJ雖然答應入隊，但他平常大部分的時間都人間蒸發，看來是在參與什麼可疑活動。'
        ]
    }
]